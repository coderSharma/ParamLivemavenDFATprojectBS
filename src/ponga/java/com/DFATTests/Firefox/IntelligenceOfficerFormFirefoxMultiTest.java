...
public class IntelligenceOfficerFormFirefoxMultiTest {
	...
	public static void Setup() throws IOException, InterruptedException
	{
		...
		BaseClass.SOHTMLGENERAL(ScreenshotResult);
	...
	{
		Roles_VacanciesPageObjects RolesPage = PageFactory.initElements(driver,Roles_VacanciesPageObjects.class);
		...
		RolesPage.ClickViewAndApplyIOfficerButton();
		IORolesPage.ClickApplyNowButton();
	}
	...
	{
		//reportContent=BaseClass.tearDown(driver, Results,TcaseName);
		String Content="<tr BGCOLOR= "+colour+"><td>1</td><td>TestCase</td><td>"+reportContent+"</td><td></td></tr>";
		BaseClass.myWriteAppend(ScreenshotResult,Content);
		BaseClass.myWriteAppend(ScreenshotResult,"</table>");
		BaseClass.myWriteAppend(ScreenshotResult,"</center>");
		BaseClass.myWriteAppend(ScreenshotResult,"<table border = \"0\" cellspacing = \"0\" cellpadding = \"10\"><tr>");
		BaseClass.EOHTMLGEN(ScreenshotResult);
