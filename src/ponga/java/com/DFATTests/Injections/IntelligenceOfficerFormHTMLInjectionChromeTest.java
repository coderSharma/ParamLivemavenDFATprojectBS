package com.DFATTests.Injections;
...
public class IntelligenceOfficerFormHTMLInjectionChromeTest {
	...
	public void C_FillFormFormPersonalSectionComplete() throws InterruptedException
	{
		...
		TcaseName.add(name.getMethodName());
		Results.add(FormPersonalSection.FillFormStandard());
	}
	@Test
	...
	public void G_FillFormExtendedResponseSectionComplete() throws InterruptedException
	{
		...
		TcaseName.add(name.getMethodName());
		Results.add(FormExtendedResponseSection.FillFormHtmlInjection(driver));
	}
